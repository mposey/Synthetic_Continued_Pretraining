#!/bin/bash
#SBATCH -J rephrase_cpt                      # Job name
#SBATCH -o rephrase_cpt_%j.out               # output file (%j expands to jobID)
#SBATCH -e rephrase_cpt_%j.err               # error log file (%j expands to jobID)
